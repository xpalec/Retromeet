...
import {
  ACTION_RETRO,
  ACTION_RETRO_JOIN, ACTION_RETRO_LEAVE, ACTION_RETRO_NEW, ACTION_RETRO_RENAME,
  RETRO_JOIN_FAILURE, RETRO_JOIN_SUCCESS, RETRO_LEAVE,
  RETRO_NEW_FAILURE, RETRO_NEW_SUCCESS, RETRO_RECEIVED,
  RETRO_RENAME_FAILURE, RETRO_RENAME_SUCCESS
} from './retro';
import {
...
export const socketActions = {
  ...
  [ACTION_RETRO_RENAME]: [RETRO_RENAME_SUCCESS, RETRO_RENAME_FAILURE],
